    ...
    <div className="bg-[#FAF7F2] text-gray-900 overflow-hidden">
      ...
      <section className="min-h-[75vh] flex flex-col lg:gap-20 md:flex-row items-center px-6 md:px-16 lg:px-30 py-6 md:py-12 bg-gradient-to-b from-[#ce676a] to-[#fff]">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-[#2D2A55] leading-snug">
            Nestlers
          </h1>

          <p className="mt-4 text-base md:text-base lg:text-lg text-gray-700 md:leading-tight lg:leading-relaxed">
            Our Nestlers program is thoughtfully designed for toddlers aged 2–3 years,
            focusing on early development through play, care, and discovery.
          </p>
      ...
      {/* ---------------- MAIN CONTENT ---------------- */}
      <section className="px-6 lg:px-30 md:px-16 py-16 grid grid-cols-1 md:grid-cols-2 gap-20 items-start bg-white">
        ...
        <section className="grid gap-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#2D2A55] leading-tight mb-4">
              A Gentle Start to <span className ="text-orange-500">Early Learning</span>
            </h2>
            <p className="text-gray-700 text-[15px] md:text-[16px] leading-relaxed">
              The Nestlers program is designed for toddlers aged 2–3 years,
              focusing on comfort, care and early developmental milestones.
              Through play-based learning, creativity and interaction, children
              begin to explore, interact and grow in a nurturing preschool environment.
            </p>
          </motion.div>
        </section>
