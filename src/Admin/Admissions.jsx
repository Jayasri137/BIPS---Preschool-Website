...
export default function AdmissionsDashboard() {
  ...
  const performDelete = async (id, toastId) => {
    ...
    try {
      ...
      if (res.ok) {
        fetchAdmissions();
        toast.success("Admission deleted successfully", { duration: 1500 });
      } else {
    ...
    <div className="space-y-6 max-w-[1600px] mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm">Manage student admission applications</p>
        </div>
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-gray-50 rounded-xl text-xs font-bold transition-all border border-gray-200 shadow-sm text-gray-700">
            <Filter size={16} /> Filter
          </button>
          <button className="flex items-center gap-2 px-4 py-2 bg-orange-600 hover:bg-orange-700 rounded-xl text-xs font-bold text-white transition-all shadow-md">
          ...
          <table className="w-full text-left">
            <thead className="sticky top-0 z-10 bg-gray-50 shadow-sm border-b border-gray-200">
              <tr className="text-gray-500 text-[10px] uppercase tracking-widest">
                <th className="px-6 py-4 font-black">Student & Parent</th>
                <th className="px-6 py-4 font-black">Contact Details</th>
                ...
                <tr key={item.id} className="hover:bg-gray-50 transition-colors group">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-bold text-gray-900 mb-0.5">{item.studentName || "N/A"}</p>
                        <p className="text-[10px] text-gray-500 uppercase font-medium">Parent: {item.parentName}</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4">
                    <span className="px-2.5 py-1 bg-gray-100 rounded-lg text-[10px] font-black text-gray-600 border border-gray-200 uppercase">
                      {item.program}
                    </span>
                  </td>
                  <td className="px-6 py-4">
            ...
            >
              ...
              <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2 no-scrollbar">
                {historyLogs.length === 0 ? (
                  ...
                  <div key={log.id} className="relative pl-6 border-l border-gray-200 pb-4">
